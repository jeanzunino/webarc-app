...
const routes: Routes = [
  ...
  { path: PageEnum.PROVIDER, loadChildren: () => import('@app/provider/provider.module').then(m => m.ProviderModule)},
  { path: PageEnum.PRODUCT, loadChildren: () => import('@app/product/product.module').then(m => m.ProductModule)},
  { path: PageEnum.PRODUCT_CATEGORY, loadChildren: () => import('@app/product-category/product-category.module').then(m => m.ProductCategoryModule)},
