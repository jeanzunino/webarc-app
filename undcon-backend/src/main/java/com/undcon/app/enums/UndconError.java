...
public enum UndconError {
	...
	PERMISSION_ITEN_NOT_FOUND("Item de permissão não encontrado"),
	...
	PDV_CLOSED_TO_THE_LOGGED_USER("O PDV está fechado para o usuário logado"),

	SALE_INCOME_AMOUNT_PAID_IS_MAJOR_SALE_TOTAL_VALUE(
			"O Valor pago ultrapassou o valor da venda, verifique o valor a pagar"),
